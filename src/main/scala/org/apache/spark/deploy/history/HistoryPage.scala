...
private[history] class HistoryPage(parent: HistoryServer) extends WebUIPage("") 
  ...
  def render(request: HttpServletRequest): Seq[Node] = {
	...
	logDebug("*** Tenant Filtering TenantId: " + request.getAttribute("TenantId"))
    //jsingh 8/25/2023 - adding tenant level app filtering
    val displayApplications = parent.getFilteredApplicationList(request.getAttribute("TenantId").asInstanceOf[String])
